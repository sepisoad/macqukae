...
#define PLATFORM_OS2 1
    ...
    defined(__NT__) || defined(_Windows)
...
#define PLATFORM_HAIKU 1
    ...
    defined(__linux__) || defined(__linux) || defined(__FreeBSD__) ||        \
    defined(__DragonFly__) ||                                                \
    defined(__FreeBSD_kernel__) /* Debian GNU/kFreeBSD */ ||                 \
    defined(__OpenBSD__) || defined(__NetBSD__) || defined(__hpux) ||        \
    defined(__hpux__) || defined(_hpux) || defined(__sun) || defined(sun) || \
    defined(__sgi) || defined(sgi) || defined(__sgi__) ||                    \
    defined(__GNU__) /* GNU/Hurd */ || defined(__QNX__) || defined(__QNXNTO__)
